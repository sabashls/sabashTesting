...
var config = {
    ...
    dbURI:'mongodb://20.0.0.26:27017/sashcash_test',
    http: {
        host: "0.0.0.0",
        enabled: true,
        port: 4003
    ...
    payuMoney:{
        ...
        surl:'http://20.0.0.26:4003/payment/response',
        furl:'http://20.0.0.26:4003/payment/response',
        ...
        redirectURL:'http://20.0.0.26:4000/user/#/rechargeSummary/'
    },
    ...
    completeEmailUrl:'http://20.0.0.26:8001/campaigns/completeCampaignEmail',
    sendMail : {
