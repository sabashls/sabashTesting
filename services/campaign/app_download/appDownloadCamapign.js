...
exports.appDownloadBackground = function (req, res) {
...
exports.appDownloadList = function (req, res) {

    console.log('App campaign List',req.body)
...
exports.specificappDownload = function (request, response) {
                            ...
                            clickDB.find({campaign: request.body.campaign_id,}, function (err2, clickCount) {
                                ...
                                if (err2) {
                                    ...
                                    return;
                                        ...
                                        console.log(clickCount.length,'else1',campaign.clicks)
                                        if (clickCount.length < (campaign.clicks * 2)) {
...
exports.completeappDownloadCampaign = function (request, response) {
