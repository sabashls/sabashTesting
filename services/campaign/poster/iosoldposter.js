...
exports.posterBackground = function (request, response) {
...
exports.posterList = function (request, response) {

    console.log('campaisssssssssssssssssssssssssssssssssssssssssssssssssssssgnList',request.body.user_id)
    ...
    try {
        ...
        user.findById(request.body.user_id, function (err, doc) {
            ...
            if (err || !doc) {
                ...
                console.log(data._id,"datadatadatadata")
                console.log(data,"datadatadatadatassssssssssssssssssssssssssssssssssss")
                ...
                if (data.verified == '0' || data.verified == 0) {
                    ...
                    view.find({user: data._id}).exec(function (err, viewList) {
                        ...
                        console.log(request.body,"oksokaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaadp")
...
exports.specificPoster = function (request, response) {
                            ...
                            clickDB.find({campaign: request.body.campaign_id,}, function (err2, clickCount) {
                                ...
                                if (err2) {
                                    ...
                                    /*else if(campaign.is_android == 1){
                                     ...
                                     response.json({status: 'success', data: campaign})
                                     }
                                     else {
...
exports.completePosterCampaign = function (request, response) {
