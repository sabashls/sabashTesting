...
exports.posterBackground = function (req, res) {
                            ...
                            view.find({campaign: request.body.campaign_id,uuid:campaign.uuid}).populate('user').exec(function (err1, viewTotalCount) {
                                ...
                                if (err1) {
                                    ...
                                    if(viewTotalCount.length  >=  campaign.clicks){
                                            ...
                                            }).populate('user').exec(function (err1, viewDeviceCount)
                                            {
                                                ...
                                                if (err1) {
                                                    ...
                                                    if(viewDeviceCount.length >= campaign.android_clicks){
                                                        ...
                                                        console.log(viewDeviceCount.length + 1,'viewd campaign length == android clicks',campaign.android_clicks)
                                                                ...
                                                                if (error || !viewUserClick) {
                                                                    ...
                                                                    view.create(campaignview, function (err, viwdoc) {
                                                                        ...
                                                                        if (viwdoc){
                                                                            ...
                                                                            console.log('completed Campaign status update')
                                        ...
                                        console.log(campaign.clicks,viewTotalCount.length +1 ,'elssssssssssssssssssssssssssssssssssssssssssssssss',campaign.is_android)
