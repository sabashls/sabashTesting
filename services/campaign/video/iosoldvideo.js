...
exports.videoBackground = function (request, response) {
...
exports.videoList = function (request, response) {
        ...
        user.findById(request.body.user_id, function (err, doc) {
            ...
            if (err || !doc) {
                ...
                if (data.verified == '0' || data.verified == 0) {
                    ...
                    console.log("Add has been hosting",data._id)
                    ...
                    view.find({user: data._id}).exec(function (err, viewList) {
                        ...
                        if (err || !viewList) {
                            ...
                            }).sort({cost: -1, updated_at: 1}).exec(function (errList, list) {

                                if (errList) {

                                    console.log(err,'checking the User')
...
exports.specificVideo = function (request, response) {
...
exports.completeVideoCampaign = function (request, response) {
