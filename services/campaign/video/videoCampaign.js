...
exports.videoBackground = function (req, res) {
...
exports.videoList = function (req, res) {
    ...
    console.log('Video campaign List')
                                        ...
                                        if (clickCount.length >= (campaign.weband_clicks * 2)) {
                                            ...
                                            clickDB.findOne({
                                                ...
                                                if (userclick) {
                                                    ...
                                                    console.log('user click alerady',campaign)
                                                    response.json({status: 'success', data: {result: campaign}})
                                                }
                                                else {
